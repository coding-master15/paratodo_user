...
//
        ...
        if (isHover) {
            ...
            if (item.get("eDeliveryHelper") != null && item.get("eDeliveryHelper").equalsIgnoreCase("Yes")) {
    ...
    {
        try {
            new SimpleTooltip.Builder(mContext).padding(R.dimen._10sdp)
                    .anchorView(tooltipview)
                    .arrowDrawable(R.drawable.ic_triangle)
                    .text(generalFunc.retrieveLangLBl("includes Delivery Helper", "LBL_INC_DEL_HELPER"))
                    .gravity(Gravity.TOP)
                    .animated(false)
                    .build()
                    .show();
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        FrogoLoadingIndicatorView loaderView, loaderViewselected;
        MTextView totalfare;
        ImageView infoimage;
        ...
        public ViewHolder(View view) {
            ...
            loaderViewselected = (FrogoLoadingIndicatorView) view.findViewById(R.id.loaderViewselected);
