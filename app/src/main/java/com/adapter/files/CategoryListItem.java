...
public class CategoryListItem extends RealmObject implements Serializable {
    ...
    public String getvServiceImage(){
        return vServiceImage;
    }

    public void  setvServiceImage(String vServiceImage){
        this.vServiceImage = vServiceImage;
    }
    ...
    public String getvShortDesc() {
        return vShortDesc;
    }

    public void setvShortDesc(String vDesc) {
        this.vShortDesc = vDesc;
    }
