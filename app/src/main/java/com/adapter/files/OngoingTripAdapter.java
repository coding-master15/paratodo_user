...
//            viewHolder.bookingDateTxt.setText("");
            ...
            new CreateRoundedView(mContext.getResources().getColor(R.color.appThemeColor_2), btnRadius, strokeWidth, strokeColor, viewHolder.verifyChargesBtnArea);
...
//            viewHolder.liveTrackBtnArea.setVisibility(View.GONE);
            ...
            if (item.get("vChargesDetailDataAvailable").equalsIgnoreCase("Yes")) {
                viewHolder.verifyChargesBtn.setText(item.get("verifyChargesLBL"));
                viewHolder.verifyChargesBtnArea.setVisibility(View.VISIBLE);

            } else {
                viewHolder.verifyChargesBtnArea.setVisibility(View.GONE);

            }

            viewHolder.verifyChargesBtnArea.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    if (mItemClickListener != null) {
                        mItemClickListener.onItemClickList("Verify Charge", position);
                    }
                }
            });
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            verifyChargesBtn = (MTextView) view.findViewById(R.id.verifyChargesBtn);
            verifyChargesBtnArea = (LinearLayout) view.findViewById(R.id.verifyChargesBtnArea);
