...
*/
            ...
            if (vBookingType.equalsIgnoreCase("schedule") /*&& showUfxMultiArea*/) {
                ...
                if (item.get("showAdditionChargesBtn").equalsIgnoreCase("Yes")) {
                    ...
                    viewHolder.viewAdditionalChargesBtn.setText(item.get("verifyServiceLBL"));
                }
                ...
                viewHolder.cancelBookingBtnArea.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        btnClicked(view,position,"CancelBooking");
                    }
                });
                ...
                viewHolder.reBookingarea.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        btnClicked(view,position,"ReBooking");
                    }
                });
                ...
                viewHolder.reScheduleArea.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        btnClicked(view,position,"ReSchedule");
                    }
                });

                viewHolder.reScheduleBtnArea.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        btnClicked(view,position,"ReSchedule");
                    }
                ...
                viewHolder.viewCancelReasonBtnArea.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                       btnClicked(view,position,"ViewCancelReason");
                    }
                });
            ...
            if (item.get("showAdditionChargesBtn").equalsIgnoreCase("Yes")||(item.get(
                    "eSatisfactionApproved").equalsIgnoreCase("")) && item.get(
                            "eVerifyRequestSentByDriver").equalsIgnoreCase("Yes")) {
                isAnyButtonShown = true;
                viewHolder.viewAdditionalChargesBtnArea.setVisibility(View.VISIBLE);
            }


            viewHolder.viewAdditionalChargesBtnArea.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    if (item.get("showAdditionChargesBtn").equalsIgnoreCase("Yes")) {
                        btnClicked(view, position, "ViewAdditionalCharges");
                    }else{
                        btnClicked(view, position, "VerifyServiceEndApproval");
                    }
                }
            });
            ...
            viewHolder.liveTrackBtnArea.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    btnClicked(view,position,"LiveTrack");
            ...
            viewHolder.viewDetailsBtnArea.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    btnClicked(view,position,"ViewDetail");
                }
            });
...
public class ViewHolder extends RecyclerView.ViewHolder {
    ...
    public ViewHolder(View view) {
        ...
        viewRequestedServiceBtn = (MTextView) view.findViewById(R.id.viewRequestedServiceBtn); viewAdditionalChargesBtnArea = (LinearLayout) view.findViewById(R.id.viewAdditionalChargesBtnArea);
