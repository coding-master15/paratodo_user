...
public class ApplyCouponAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        if (holder instanceof ViewHolder) {
            ...
            String fDiscount = Utils.checkText(fDiscountSymbol)?fDiscountSymbol:(isCash ? new AppFunctions(mContext).formatNumAsPerCurrency(generalFunc,item.get("fDiscount"),currencySymbol,true) + "" : item.get("fDiscount") + "%");
