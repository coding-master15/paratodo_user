...
public class VerifyServiceActivity extends BaseActivity {
    ...
    public Context getActContext() {
        return VerifyServiceActivity.this;
    }
    ...
    public void initViews() {
        ...
        finalvalTxt.setVisibility(View.GONE);

        String eVerifyRequestSentByDriver=getIntent().getStringExtra("eVerifyRequestSentByDriver");
        if (Utils.checkText(eVerifyRequestSentByDriver) && eVerifyRequestSentByDriver.equalsIgnoreCase("Yes") && !Utils.checkText(vConfirmationCode))
        {
            btnArea.setVisibility(View.VISIBLE);
            confirmationCodeArea.setVisibility(View.GONE);
            noteTxt.setText(generalFunc.retrieveLangLBl("", "LBL_SATISFICATION_USER_NOTE"));
        ...
        finalHTxt.setVisibility(View.GONE);
    ...
    public void setLabel() {
        ...
        titleTxt.setText(generalFunc.retrieveLangLBl("", "LBL_SATISFICATION_SERVICE_HEADER_TXT"));
    ...
    public void pubNubMsgArrived(final String message, final Boolean ishow) {
        ...
        runOnUiThread(() -> {
            ...
            if (getIntent().getStringExtra("iDriverId").equals(iDriverId)) {
              if (msgType.equals("SatisficationConfirm")) {
    ...
    public void onGcmMessageArrived(final String message, boolean ishow) {
        ...
        if (driverMsg.equals("SatisficationConfirm")) {
           /* isVerifyCharges=true;
            verifyPushMsg=message;*/
            Intent returnIntent = new Intent();
            setResult(Activity.RESULT_OK, returnIntent);
    ...
    private void sendChargeVerificationCode(String eApproveByUser) {
        ...
        parameters.put("type", "sendApprovalRequest");
        parameters.put("TripId", getIntent().getStringExtra("iTripId"));
        parameters.put("iUserId", generalFunc.getMemberId());
        parameters.put("UserType", Utils.app_type);
        parameters.put("eSatisfactionByUser", eApproveByUser);
