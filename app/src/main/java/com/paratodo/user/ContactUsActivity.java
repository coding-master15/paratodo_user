...
public class ContactUsActivity extends AppCompatActivity {
    ...
    public void setLabels() {
        ...
        if (generalFunc.isRTLmode()) {
            subjectBox.setPadding(0,0,(int)getResources().getDimension( R.dimen._10sdp),0);
        }else {
            subjectBox.setPadding((int)getResources().getDimension( R.dimen._10sdp),0,0,0);
        }
        ...
        if (generalFunc.isRTLmode()) {
            contentBox.setPadding(0,0,(int)getResources().getDimension( R.dimen._10sdp),0);
        }else {
            contentBox.setPadding((int)getResources().getDimension( R.dimen._10sdp),0,0,0);
        }
