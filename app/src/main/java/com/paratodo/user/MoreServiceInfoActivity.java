                ...
                if (isDataAvail) {
                    ...
                    if (itemArray!=null) {
                        ...
                        for (int i = 0; i < itemArray.length(); i++) {
                            ...
                            MTextView estimateTxt = (MTextView) editCartView.findViewById(R.id.estimateTxt);
                            MTextView estimatePriceTxt = (MTextView) editCartView.findViewById(R.id.estimatePriceTxt);
                            ...
                            estimateTxt.setText(generalFunc.retrieveLangLBl("", "LBL_ESTIMATED_CHARGE"));
                            estimatePriceTxt.setText(generalFunc.getJsonValue("estimateFare", data.toString()));
