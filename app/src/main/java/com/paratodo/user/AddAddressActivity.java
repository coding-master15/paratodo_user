...
public class AddAddressActivity extends AppCompatActivity implements OnMapReadyCallback, GetLocationUpdates.LocationUpdates, GetAddressFromLocation.AddressFound, GoogleMap.OnCameraMoveStartedListener, GoogleMap.OnCameraIdleListener {
    ...
    TextInputEditText buildingBox;
    TextInputEditText personNameBox;
    LinearLayout personNameArea;
    TextInputEditText landmarkBox;
    TextInputEditText StoreBox;
    TextInputEditText addrtypeBox;
    TextInputEditText apartmentLocNameBox;
    TextInputEditText companyBox;
    TextInputEditText postCodeBox;
    TextInputEditText addr2Box;
    TextInputEditText deliveryIntructionBox;
    TextInputEditText vContryBox;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buildingBox = (TextInputEditText) findViewById(R.id.buildingBox).findViewWithTag("edittext");
        personNameBox = (TextInputEditText) findViewById(R.id.personNameBox).findViewWithTag("edittext");
        personNameArea = (LinearLayout) findViewById(R.id.personNameArea);
        landmarkBox = (TextInputEditText) findViewById(R.id.landmarkBox).findViewWithTag("edittext");
        StoreBox = (TextInputEditText) findViewById(R.id.StoreBox).findViewWithTag("edittext");
        addrtypeBox = (TextInputEditText) findViewById(R.id.addrtypeBox).findViewWithTag("edittext");
        ...
        apartmentLocNameBox = (TextInputEditText) findViewById(R.id.apartmentLocNameBox).findViewWithTag("edittext");
        companyBox = (TextInputEditText) findViewById(R.id.companyBox).findViewWithTag("edittext");
        postCodeBox = (TextInputEditText) findViewById(R.id.postCodeBox).findViewWithTag("edittext");
        addr2Box = (TextInputEditText) findViewById(R.id.addr2Box).findViewWithTag("edittext");
        deliveryIntructionBox = (TextInputEditText) findViewById(R.id.deliveryIntructionBox).findViewWithTag("edittext");
        vContryBox = (TextInputEditText) findViewById(R.id.vContryBox).findViewWithTag("edittext");
...
//        AddrareaTxtView = (MTextView) findViewById(R.id.AddrareaTxtView);
    ...
    private void setLabel() {
        ...
        (buildingBox).setHint(generalFunc.retrieveLangLBl("Building/House/Flat No.", "LBL_JOB_LOCATION_HINT_INFO"));
        personNameBox.setHint(generalFunc.retrieveLangLBl("Contact Person Name.", "LBL_CONTACT_PERSON_NAME"));
        landmarkBox.setHint(generalFunc.retrieveLangLBl("Landmark(e.g hospital,park etc.)", "LBL_LANDMARK_HINT_INFO"));
        StoreBox.setHint(generalFunc.retrieveLangLBl("Store Name", "LBL_STORENAME_TXT"));
        addrtypeBox.setHint(generalFunc.retrieveLangLBl("Nickname(optional-home,office etc.)", "LBL_ADDRESSTYPE_HINT_INFO"));
