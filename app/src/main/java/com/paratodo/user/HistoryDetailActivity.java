...
import static com.paratodo.user.R.id.ratingBar;
...
public class HistoryDetailActivity extends AppCompatActivity {
    ...
    ScaleRatingBar safetyRatingBar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ufxratingBar = (ScaleRatingBar) findViewById(R.id.ufxratingBar);
                    ...
                    if (arr_rides != null && arr_rides.length() > 0) {
                        for (int i = 0; i < arr_rides.length(); i++) {
                            ...
                            if (ShowSafetyRating.equalsIgnoreCase("Yes")) {
                                ...
                                ufxratingBar.setOnRatingChangeListener(new BaseRatingBar.OnRatingChangeListener() {
                                    @Override
    ...
    private void showSafetyRatingArea(boolean show) {
        if (show) {
            ...
            if (!isAnimated) {
                ...
                ufxratingBar.setIsIndicator(true);
...
//
            ...
            if (isAnimated) {
                ...
                ufxratingBar.setIsIndicator(false);
...
//        ((MTextView) findViewById(R.id.ratingHTxt)).setText(generalFunc.retrieveLangLBl("", "LBL_RATING"));
    ...
    public void setData(String tripData) {
        ...
        ((ScaleRatingBar) findViewById(ratingBar)).setRating(GeneralFunctions.parseFloatValue(0, generalFunc.getJsonValue("TripRating", tripData)));
    ...
    public class setOnClickList implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (view.getId() == rateBtnId) {
                if (((ScaleRatingBar) findViewById(R.id.ufxratingBar)).getRating() <= 0.0) {
