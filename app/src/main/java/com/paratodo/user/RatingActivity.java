...
public class RatingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        safetyRatingBar = (ScaleRatingBar) findViewById(R.id.safetyRatingBar);
        ...
        if (generalFunc.isRTLmode()) {
            commentBox.setPadding(0, 0, (int) getResources().getDimension(R.dimen._5sdp), 0);
        } else {
            commentBox.setPadding((int) getResources().getDimension(R.dimen._5sdp), 0, 0, 0);
        }
                ...
                if (GeneralFunctions.checkDataAvail(Utils.action_str, responseString)) {
                    ...
                    if (ShowSafetyRating.equalsIgnoreCase("Yes")) {
                        ...
                        ratingBar.setOnRatingChangeListener(new BaseRatingBar.OnRatingChangeListener() {
                            @Override
                            public void onRatingChange(BaseRatingBar simpleRatingBar, float rating, boolean fromUser) {
...
//
    ...
    public void buildTipCollectMessage(String message, String positiveBtn, String negativeBtn) {
        ...
        final TextInputEditText tipAmountEditBox = (TextInputEditText) dialogView.findViewById(R.id.editBox).findViewWithTag("edittext");
