...
public class MoreInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ScaleRatingBar bottomViewratingBar = (ScaleRatingBar) findViewById(R.id.bottomViewratingBar);
        ...
        if (generalFunc.getJsonValue("ENABLE_SEARCH_UFX_SERVICES", userProfileJson) != null &&
                generalFunc.getJsonValue("ENABLE_SEARCH_UFX_SERVICES", userProfileJson).equalsIgnoreCase("Yes")) {
...
//            itemNpricecartTxt.setText(realmCartList.get(0).getvSymbol() + "" + generalFunc.convertNumberWithRTL(GeneralFunctions.convertDecimalPlaceDisplay(finlaTotal) + ""));
            itemNpricecartTxt.setText(new AppFunctions(getActContext()).formatNumAsPerCurrency(generalFunc, "" + generalFunc.convertNumberWithRTL(GeneralFunctions.convertDecimalPlaceDisplay(finlaTotal) + ""), realmCartList.get(0).getvSymbol(), true));
    ...
    CarouselViewListener viewListener = (view, position) -> {
        ImageView customView = view.findViewById(R.id.carouselImageView);
        ...
        Picasso.get()
                .load(Utils.getResizeImgURL(getActContext(), item.get("vImage"), ((int) Utils.getScreenPixelWidth(getActContext())) - dip, 0, Utils.getScreenPixelHeight(getActContext()) - dip))
    ...
    public void openCarouselView(ArrayList<HashMap<String, String>> galleryListData, int currentPosition) {
        ...
        //carouselView.setSize(galleryListData.size());
        ...
        public void onClick(View view) {
            ...
            switch (view.getId()) {
                ...
                case R.id.searchImgView:
                    ...
                    new StartActProcess(getActContext()).startActForResult(SearchCategoryActivity.class, bundlesearch, SEARCH_CATEGORY);
