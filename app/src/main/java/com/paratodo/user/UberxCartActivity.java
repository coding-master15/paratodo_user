...
public class UberxCartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWindow().getDecorView().setOnApplyWindowInsetsListener((v, insets) -> {
            ...
            View content = findViewById(R.id.cartView);
            if (content != null) {
        ...
        if (generalFunc.isRTLmode()) {
            commentBox.setPadding((int) getResources().getDimension(R.dimen._5sdp), 0, (int) getResources().getDimension(R.dimen._10sdp), 0);
        } else {
            commentBox.setPadding((int) getResources().getDimension(R.dimen._10sdp), 0, (int) getResources().getDimension(R.dimen._5sdp), 0);
        }
