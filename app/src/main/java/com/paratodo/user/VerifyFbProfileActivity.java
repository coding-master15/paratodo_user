...
public class VerifyFbProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fNameBox = (TextInputEditText) findViewById(R.id.fNameBox).findViewWithTag("edittext");
        lNameBox = (TextInputEditText) findViewById(R.id.lNameBox).findViewWithTag("edittext");
