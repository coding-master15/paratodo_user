...
public class CardPaymentActivity extends AppCompatActivity {
    ...
    public void openViewCardFrag() {
        ...
        if (getIntent().getStringExtra("selCardPayment") != null && !getIntent().getStringExtra("selCardPayment").equalsIgnoreCase("")) {
            Bundle bn = new Bundle();
            bn.putBoolean("isOpen", true);
            bn.putString("selCardPayment", getIntent().getStringExtra("selCardPayment"));
            viewCardFrag.setArguments(bn);
    ...
    public void openAddCardFrag(String mode) {
        ...
        if (APP_PAYMENT_METHOD.equalsIgnoreCase("CyberSource")) {
            ...
            generateAlert.setContentMessage("", generalFunc.getJsonValueStr("ADEYN_CHARGE_MESSAGE", userProfileJsonObj));
