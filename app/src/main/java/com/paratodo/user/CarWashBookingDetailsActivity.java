    ...
    public void getDetails() {
        ...
        exeWebServer.setDataResponseListener(responseString -> {
            ...
            if (responseString != null && !responseString.equals("")) {
                ...
                boolean isDataAvail = true || GeneralFunctions.checkDataAvail(Utils.action_str, responseString);
                if (isDataAvail) {
                    ...
                    totalAddressCount = generalFunc.getIntValue("totalAddressCount", responseString);
                    ...
                    total_fare_amount = generalFunc.getJsonValue("total_fare_amount", responseString);
    ...
    public class setOnClickList implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (i == R.id.backImgView) {
                ...
                bn.putString("Amount", total_fare_amount);
...
//                bn.putString("msg", "DO_PHONE_VERIFY");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == Utils.SELECT_COUPON_REQ_CODE && resultCode == RESULT_OK) {
            ...
            if (ENABLE_SAFETY_CHECKLIST.equalsIgnoreCase("Yes") && generalFunc.getJsonValue("ENABLE_SAFETY_FEATURE_UFX", userProfileJson).equalsIgnoreCase("Yes")) {
                Bundle bn = new Bundle();
