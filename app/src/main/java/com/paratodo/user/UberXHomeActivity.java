...
//    }
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    highlightImg = findViewById(R.id.highlightImg);
...
//                .replace(R.id.fragContainer, myBookingFragment).commit();
  ...
  private void updateOnGoingTripCounter() {
    HashMap<String, String> parameters = new HashMap<String, String>();
    parameters.put("type", "updateOnGoingTripCounter");
    ...
    exeWebServer.setDataResponseListener(responseString -> {
      ...
      if (responseString != null && !responseString.equals("")) {
        ...
        if (isDataAvail == true) {
          ...
          String tripCount = generalFunc.getJsonValue("tripCount", responseString);
          if (!tripCount.equalsIgnoreCase("") && !tripCount.equalsIgnoreCase("0")) {
            highlightImg.setVisibility(View.VISIBLE);
            /*LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT, LinearLayout.LayoutParams.WRAP_CONTENT);
            params.setMargins(0, 25, 0, -5);
            historyTxt.setLayoutParams(params);*/
          } else {
            highlightImg.setVisibility(View.GONE);
          }
