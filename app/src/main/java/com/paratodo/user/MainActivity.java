...
public class MainActivity extends BaseActivity implements OnMapReadyCallback, GoogleMap.OnMapClickListener, GetLocationUpdates.LocationUpdates, tooltipdeledgate {
    ...
    public FrogoLoadingIndicatorView loaderView;
...
*/
    ...
    public void getSkyPortsPoints() {
        ...
        exeWebServer.setDataResponseListener(responseString -> {
            ...
            Log.e("OKKK5", responseString);
            Log.e("OKKK5", parameters.toString());
...
//                    pickUpLocationAddress = getIntent().getStringExtra("address");
    ...
    public void getWalletBalDetails() {
        ...
        exeWebServer.setDataResponseListener(responseString -> {
            ...
            Log.e("OKKK4", responseString);
            Log.e("OKKK4", parameters.toString());
...
//                    pickUpLocation = userLocation;
    ...
    private void setBottomView(final Marker marker) {
        ...
        if (isPickUpLocationCorrect() == false || map.size() == 0) {
            ...
            ScaleRatingBar bottomViewratingBar = (ScaleRatingBar) findViewById(R.id.bottomratingBar);
...
//                .setIs24HourTime(true)
    ...
    public void checkSurgePrice(final String selectedTime, final Intent data) {
        ...
        exeWebServer.setDataResponseListener(responseString -> {
            ...
            Log.e("OKKK3", responseString);
            Log.e("OKKK3", parameters.toString());
...
//        bn.putString("UserProfileJson", "" + userProfileJson);
    ...
    public void bookRide() {
        ...
        if (deliveryData != null) {
            if (isMultiDelivery()) {
                ...
                if (deliveryData.hasExtra("isMulti")) {
                    parameters.put("CashPayment", "" + deliveryData.getStringExtra("isCashPayment"));
        ...
        exeWebServer.setDataResponseListener(responseString -> {
            ...
            Log.e("OKKK", parameters.toString());
            Log.e("OKKK", responseString);
...
//                new StartActProcess(getActContext()).startActForResult(OnGoingTripsActivity.class, bn, Utils.ASSIGN_DRIVER_CODE);
            ...
            if (generalFunc.getJsonValue("APP_TYPE", userProfileJson).equals(Utils.CabGeneralType_UberX)) {
                ...
                if (generalFunc.getJsonValue("APP_TYPE", userProfileJson).equals(Utils.CabGeneralTypeRide_Delivery_UberX)) {
                    ...
                    if (generalFunc.getJsonValue("ENABLE_RIDE_DELIVERY_NEW_FLOW", userProfileJson).equals("Yes")) {
                        new StartActProcess(getActContext()).startActWithData(RideDeliveryActivity.class, bn);
                    } else {
...
//                new StartActProcess(getActContext()).startActForResult(OnGoingTripsActivity.class, bn, Utils.ASSIGN_DRIVER_CODE);
    ...
    public void scheduleDelivery(Intent data) {
        ...
        exeWebServer.setDataResponseListener(responseString -> {
            ...
            Log.e("OKKK2", responseString);
            Log.e("OKKK2", parameters.toString());
...
//                requestNearestCab.setVisibilityOfRetryArea(View.GONE);
    ...
    public void sendRequestToDrivers(String driverIds, String cabRequestedJson) {
        ...
        exeWebServer.setDataResponseListener(responseString -> {
            Log.e("OKKK3", responseString);
            Log.e("OKKK3", requestCabData.toString());
            if (cabSelectionFrag != null) {
...
//
            ...
            if (resultCode == RESULT_OK) {
                if (!data.getBooleanExtra("isCash", false)) {
                    ...
                    if (Utils.checkText(data.getStringExtra("selCardPayment"))) {
                        if (data.getStringExtra("selCardPayment").equalsIgnoreCase("wallet")) {
                            PaymentMode = "wallet";
                        }
                    }
