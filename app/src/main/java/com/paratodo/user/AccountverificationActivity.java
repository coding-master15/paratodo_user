...
public class AccountverificationActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        emailBox = (TextInputEditText) findViewById(R.id.emailBox).findViewWithTag("edittext");
        countryBox = (TextInputEditText) findViewById(R.id.countryBox).findViewWithTag("edittext");
        mobileBox = (TextInputEditText) findViewById(R.id.mobileBox).findViewWithTag("edittext");
        ...
        invitecodeBox = (TextInputEditText) findViewById(R.id.invitecodeBox).findViewWithTag("edittext");
        ...
        countryBox.setPadding(generalFunc.isRTLmode() ? 0 : paddingVal, 0, generalFunc.isRTLmode() ? paddingVal : 0, 0);
        ...
        String vPhone=generalFunc.getJsonValueStr("vPhone", userProfileJsonObj);
        if (vPhone.equals("")) {
    ...
    private void setLabel() {
        ...
        invitecodeBox.setHint(generalFunc.retrieveLangLBl("", "LBL_INVITE_CODE_HINT"));
