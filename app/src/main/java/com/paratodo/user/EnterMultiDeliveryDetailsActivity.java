...
public class EnterMultiDeliveryDetailsActivity extends AppCompatActivity implements TextWatcher, TextWatcherExtendedListener, Serializable {
    ...
    TextInputEditText receiverNameEditBox;
    TextInputEditText receiverMobileEditBox;
    TextInputEditText pickUpInstructionEditBox;
    TextInputEditText deliveryInstructionEditBox;
    TextInputEditText packageTypeBox;
    TextInputEditText packageDetailsEditBox;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        receiverNameEditBox = (TextInputEditText) findViewById(R.id.receiverNameEditBox).findViewWithTag("edittext");
        receiverMobileEditBox = (TextInputEditText) findViewById(R.id.receiverMobileEditBox).findViewWithTag("edittext");
        pickUpInstructionEditBox = (TextInputEditText) findViewById(R.id.pickUpInstructionEditBox).findViewWithTag("edittext");
        deliveryInstructionEditBox = (TextInputEditText) findViewById(R.id.deliveryInstructionEditBox).findViewWithTag("edittext");
        packageTypeBox = (TextInputEditText) findViewById(R.id.packageTypeBox).findViewWithTag("edittext");
        packageDetailsEditBox = (TextInputEditText) findViewById(R.id.packageDetailsEditBox).findViewWithTag("edittext");
        ...
        if (generalFunc.isRTLmode()) {
            pickUpInstructionEditBox.setPadding(0, 0, (int) getResources().getDimension(R.dimen._10sdp), 0);
        } else {
            pickUpInstructionEditBox.setPadding((int) getResources().getDimension(R.dimen._10sdp), 0, 0, 0);
        }
        ...
        if (generalFunc.isRTLmode()) {
            deliveryInstructionEditBox.setPadding(0, 0, (int) getResources().getDimension(R.dimen._10sdp),0 );
        } else {
            deliveryInstructionEditBox.setPadding((int) getResources().getDimension(R.dimen._10sdp), 0, 0, 0);
        }
...
//                dt.setAddressHintTxt(generalFunc.retrieveLangLBl("", "LBL_SELECT_ADDRESS_TITLE_TXT"));
    ...
    private void addDetailRow(int pos, boolean b) {
        ...
        TextInputEditText textField = (TextInputEditText) convertView.findViewById(R.id.textField).findViewWithTag("edittext");
        FrameLayout selectArea = (FrameLayout) convertView.findViewById(R.id.selectArea);
        TextInputEditText selectBox = (TextInputEditText) convertView.findViewById(R.id.selectBox).findViewWithTag("edittext");
        ...
        TextInputEditText multiLineText = (TextInputEditText) convertView.findViewById(R.id.multiLineText);
        ...
        if (generalFunc.isRTLmode()) {
            multiLineText.setPadding(0, 0, (int) getResources().getDimension(R.dimen._10sdp), 0);
        } else {
            multiLineText.setPadding((int) getResources().getDimension(R.dimen._10sdp), 0, 0, 0);
        }
...
//            selectBox.setHint(posData.getvFieldName());
        ...
        if (requestCode == Utils.ADD_LOC_REQ_CODE && resultCode == RESULT_OK && data != null) {
            ...
            if (data.hasExtra("pos")) {
                ...
                if (pos != -1) {
                    ...
                    ((TextInputEditText) dataArrayList.get(pos)).setText(data.getStringExtra("Address"));
        ...
        for (int i = 0; i < data.size(); i++) {
            ...
            if (posDats.geteInputType().equalsIgnoreCase(data.get(i).geteInputType())) {
                ...
                if (data.get(i).geteInputType().equalsIgnoreCase("SelectAddress")) {
                    ...
                    ((TextInputEditText) dataArrayList.get(pos)).setText(data.get(i).getDestAddress());
                ...
                if (data.get(i).geteInputType().equalsIgnoreCase("Select")) {
                    if (posDats.getiDeliveryFieldId().equalsIgnoreCase(data.get(i).getiDeliveryFieldId())) {
                        ...
                        ((TextInputEditText) dataArrayList.get(pos)).setText(data.get(i).getvFieldValue());
                    }
                } else {
    ...
    private void setData(Delivery_Data data, int pos) {
        ...
        if (data != null) {
            ...
            if (data.geteInputType().equalsIgnoreCase("SelectAddress")) {
                ...
                ((TextInputEditText) dataArrayList.get(pos)).setText(data.getDestAddress());
            ...
            if (data.geteInputType().equalsIgnoreCase("Select")) {
                if (posData.getiDeliveryFieldId().equalsIgnoreCase(data.getiDeliveryFieldId())) {
                    ...
                    ((TextInputEditText) dataArrayList.get(pos)).setText(data.getvFieldValue());
                }
            } else {
    ...
    private void setData(JSONObject ja, int pos) {
        ...
        if (generalFunc.getJsonValueStr("eInputType", ja).equalsIgnoreCase("Select")) {
            ...
            if (posData.getiDeliveryFieldId().equalsIgnoreCase(generalFunc.getJsonValueStr("iDeliveryFieldId", ja))) {
                ...
                ((TextInputEditText) dataArrayList.get(pos)).setText(generalFunc.getJsonValueStr("vFieldValue", ja));
    ...
    public void setLabels() {
        ...
        receiverNameEditBox.setHint(generalFunc.retrieveLangLBl("Receiver Name", "LBL_RECEIVER_NAME"));
        receiverMobileEditBox.setHint(generalFunc.retrieveLangLBl("Receiver Mobile", "LBL_RECEIVER_MOBILE"));
        ...
        packageTypeBox.setHint(generalFunc.retrieveLangLBl("Select package type", "LBL_SELECT_PACKAGE_TYPE"));
        packageDetailsEditBox.setHint(generalFunc.retrieveLangLBl("Package Details", "LBL_PACKAGE_DETAILS"));
    ...
    public void buildPackageTypes(TextInputEditText selectBox, String message, int viewId) {
    ...
    public void showPackageTypes(TextInputEditText selectBox, int viewId,int selectedOptionPos) {
    ...
    public void checkDetails() {
        ...
        for (int i = 0; i < dataArrayList.size(); i++) {
            if (dataArrayList.get(i) instanceof TextInputEditText) {

                if (Utils.checkText((TextInputEditText) dataArrayList.get(i))) {
                    any1DetailEntered = true;
                }

                if (elementArrayList.get(i).geteRequired().equalsIgnoreCase("Yes")) {
                    boolean detailEntered = Utils.checkText((TextInputEditText) dataArrayList.get(i)) ? true : Utils.setErrorFields((TextInputEditText) dataArrayList.get(i), required_str);
            ...
            public void setResponse(String responseString) {
                ...
                if (responseString != null && !responseString.equals("")) {
                    if (generalFunc.getJsonValue("Action", responseString).equalsIgnoreCase("0")) {
                        ...
                        //if(getIntent().getBooleanExtra("isFromMulti",true)) {
                            storeDetails();
                      //  }
//                        else {
//
...
//                        }
    ...
    private void storeDetails(Bundle data) {
        ...
        try {
            ...
            generalFunc.storeData(Utils.MUTLI_DELIVERY_JSON_DETAILS_KEY, jaStore.toString());

        } catch (Exception e) {
            e.printStackTrace();
        }

        data.putInt("selectedPos", 0);
    ...
    private JSONObject storeDetails(int pos, JSONArray jsonArray, ArrayList<Delivery_Data> finalAllDetailsArray1) {
        ...
        try {
            ...
            if (dataArrayList.get(pos) instanceof TextInputEditText) {
                if (details.geteInputType().equals("Select")) {
                    details.setvFieldValue(((TextInputEditText) dataArrayList.get(pos)).getText().toString());
    ...
    public void resetAllView() {
        for (int i = 0; i < dataArrayList.size(); i++) {
            if (dataArrayList.get(i) instanceof TextInputEditText) {
                ((TextInputEditText) dataArrayList.get(i)).setText("");
            }
        }
    }
