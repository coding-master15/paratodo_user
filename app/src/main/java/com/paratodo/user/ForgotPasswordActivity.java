...
public class ForgotPasswordActivity extends AppCompatActivity implements GenerateAlertBox.HandleAlertBtnClick {
    ...
    private void setLabel() {
        ...
        emailBox.setHint(generalFunc.retrieveLangLBl("", generalFunc.retrieveValue("ENABLE_PHONE_LOGIN_VIA_COUNTRY_SELECTION_METHOD").equalsIgnoreCase("Yes")?"LBL_PHONE_EMAIL":"LBL_EMAIL_LBL_TXT"));
            ...
            emailBox.addTextChangedListener(new TextWatcher() {
                ...
                public void onTextChanged(CharSequence s, int start, int before, int count) {
                    ...
                    if (Utils.checkText(s.toString().trim())&&s.toString().trim().matches(regexStr)) {
                        emailBox.setHint(generalFunc.retrieveLangLBl("", "LBL_MOBILE_NUMBER_HEADER_TXT"));
                        isEmail = false;
