...
public class ExecuteWebServerUrl {
    ...
    public ExecuteWebServerUrl(Context mContext, HashMap<String, String> parameters) {
        ...
        Log.e("okkkka", parameters.get("type"));
    }
    ...
    public void execute() {
        ...
        if (parametersObj != null) {
            ...
            parametersObj.put("CUS_IS_SINGLE_STORE_SELECTION", "Yes");
            ...
            parametersObj.put("CUS_IS_SINGLE_STORE_SELECTION","No");
            ...
            parameters.put("CUS_IS_SINGLE_STORE_SELECTION","No");
        ...
        if (generalFunc != null) {
            String vDeviceToken = MyFirebaseMessagingService.getToken(mContext);
