...
public class OpenLinkedinDialog {
    ...
    public void show() {
        ...
        loaderView = (FrogoLoadingIndicatorView) dialogView.findViewById(R.id.loaderView);
                ...
                if (isDataAvail) {
                    ...
                    if (appMainLoginAct == null) {
                        if (isrestart) {
                            ...
                            boolean isEmailBlankAndOptional = new AppFunctions(mContext).isEmailBlankAndOptional(generalFunc, generalFunc.getJsonValue("vEmail", userProfileJsonObj));
