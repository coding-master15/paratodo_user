...
import com.paratodo.user.AccountverificationActivity;
import com.paratodo.user.BuildConfig;
import com.paratodo.user.CarWashBookingDetailsActivity;
import com.paratodo.user.CommonDeliveryTypeSelectionActivity;
import com.paratodo.user.LauncherActivity;
import com.paratodo.user.MainActivity;
import com.paratodo.user.MaintenanceActivity;
import com.paratodo.user.NetworkChangeReceiver;
...
import com.paratodo.user.UberXActivity;
...
public class MyApp extends Application {
    ...
    public VerifyServiceActivity verifyServiceActivity = null;
    ...
    public void onCreate() {
        ...
        //ExecuteWebServerUrl.CUS_ENABLE_ADD_PROVIDER_FROM_STORE = "";
      //  ExecuteWebServerUrl.CUS_ENABLE_TAKE_AWAY = "";
      //  ExecuteWebServerUrl.CUS_IS_SINGLE_STORE_SELECTION = "";
      //  ExecuteWebServerUrl.CUS_ENABLE_DELIVERY_PREFERENCE = "";
...
//                }
            ...
            public void onActivityResumed(Activity activity) {
                ...
                if (generalFun.isUserLoggedIn()){
                    ...
                    if (!requestPermissions.contains(Manifest.permission.ACCESS_FINE_LOCATION))
                        requestPermissions.add(Manifest.permission.ACCESS_FINE_LOCATION);
                    if (!requestPermissions.contains(Manifest.permission.ACCESS_COARSE_LOCATION))
                   ...
                   /* if (android.os.Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                    ...
                    if (!Packagetype.equalsIgnoreCase("STANDARD")){
                        if (!requestPermissions.contains(Manifest.permission.RECORD_AUDIO))
                            requestPermissions.add(Manifest.permission.RECORD_AUDIO);
                        if (!requestPermissions.contains(Manifest.permission.READ_PHONE_STATE))
...
//                            activity.finish();
            ...
            public void onActivityDestroyed(Activity activity) {
                ...
                if (activity instanceof VerifyServiceActivity && verifyServiceActivity == activity) {
                    verifyServiceActivity = null;
                }
...
//                }
                ...
                if ((activity instanceof UberXActivity && uberXAct == activity) || (uberXAct == null && commonDeliveryAct == null && activity instanceof MainActivity && mainAct == activity) || (activity instanceof CommonDeliveryTypeSelectionActivity && commonDeliveryAct == activity)) {
                    terminatePuSubInstance();
                }
            }
        });
    ...
    private void setCurrentAct(Activity currentAct) {
        ...
        if (currentAct instanceof VerifyServiceActivity) {
            verifyServiceActivity = (VerifyServiceActivity) currentAct;
        }
