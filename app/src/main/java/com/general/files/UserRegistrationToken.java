...
public class UserRegistrationToken {
    ...
    private Date instanceExpiresAt;
    ...
    public UserRegistrationToken(
        ...
        this.applicationSecret = Base64.decode(applicationSecret, Base64.DEFAULT);
        this.userId = userId;
        this.nonce = nonce;
    ...
    public String toJwt() {
        ...
        JwtBuilder builder =
                Jwts.builder()
                        .header()
                        .add("alg", alg.getValue())
                        .add("kid", JwtSigningKey.keyId(issuedAt))
                        .and()
                        .claim("iss", "//rtc.sinch.com/applications/" + applicationKey)
                        .claim("sub", "//rtc.sinch.com/applications/" + applicationKey + "/users/" + userId)
                        .claim("nonce", nonce)
                        .issuedAt(issuedAt)
