    ...
    protected void configUserStatus() {
        ...
        if (MyApp.getInstance() != null) {
            if (MyApp.getInstance().onGoingTripDetailsAct != null) {
                ...
                if (MyApp.getInstance().onGoingTripDetailsAct.tripDetailJson == null && MyApp.getInstance().onGoingTripDetailsAct.tripDetailJson.equalsIgnoreCase("")) {
                    return;
                }
                iTripId = getGeneralFunc().getJsonValue("iTripId", MyApp.getInstance().onGoingTripDetailsAct.tripDetailJson);
                iDriverId =getGeneralFunc().getJsonValue("iDriverId", MyApp.getInstance().onGoingTripDetailsAct.tripDetailJson);
                DeliverAll = "";
