...
//    }
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        FrogoLoadingIndicatorView loaderView = (FrogoLoadingIndicatorView) findViewById(R.id.loaderView);
    ...
    public void open(String url, String imageURL) {
        try {
            ...
            capacityTxt.setText(LBL_CURRENT_PERSON_LIMIT);
            FrogoLoadingIndicatorView loaderView = (FrogoLoadingIndicatorView) addAddressDailog.findViewById(R.id.loaderView);
