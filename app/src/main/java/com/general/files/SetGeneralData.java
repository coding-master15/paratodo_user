...
public class SetGeneralData {
    ...
    public SetGeneralData(GeneralFunctions generalFunc, JSONObject responseObj) {
        ...
        storeData.put("CARD_DROPDOWN", generalFunc.getJsonValueStr("CARD_DROPDOWN", responseObj));
        storeData.put("MONTH_DROPDOWN", generalFunc.getJsonValueStr("MONTH_DROPDOWN", responseObj));
        storeData.put("YEAR_DROPDOWN", generalFunc.getJsonValueStr("YEAR_DROPDOWN", responseObj));
