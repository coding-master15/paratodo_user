...
import com.paratodo.user.PrescriptionActivity;
...
public class RestaurantAllDetailsNewFragment /*extends Fragment implements AppBarLayout.OnOffsetChangedListener, SwipeRefreshLayout.OnRefreshListener*/ {
