...
/*    View view;
    ...
    ProgressBar loading;
    LinearLayout MainArea, DataArea, DataLoadingArea;
    ;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.activity_food_delivery_home, container, false);
...
//        });
        ...
        restaurantListRecycView = (RecyclerView) view.findViewById(R.id.restaurantListRecycView);
        ...
        menuSearchView = (ImageView) view.findViewById(R.id.menuSearchView);
...
//        ufxCatAdapter = new UberXCategoryAdapter(getActContext(), generalCategoryList, generalFunc);
        ...
        (view.findViewById(R.id.headerLogo)).setVisibility(View.GONE);
        (view.findViewById(R.id.uberXHeaderLayout)).setOnClickListener(new setOnClickLst());
        (view.findViewById(R.id.headerTxt)).setOnClickListener(new setOnClickLst());

        menuSearchView.setOnClickListener(new setOnClickLst());
        (view.findViewById(R.id.headerArrow)).setOnClickListener(new setOnClickLst());
    ...
    private void getRestaurantList(final double latitude, final double longitude, boolean isLoadMore) {
        ...
        exeWebServer.setDataResponseListener(responseString -> {
            ...
            if (responseObj != null && !responseObj.equals("")) {
                ...
                //add banner handling
                JSONArray arr = generalFunc.getJsonArray("banner_data", responseString);
