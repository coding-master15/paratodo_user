...
import static com.paratodo.user.R.id.demoText;
...
public class ViewCardFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //creditCardBox.setBaseColor(getResources().getColor(R.color.appThemeColor_TXT_1));
        ...
        if (generalFunc.getJsonValueStr("SITE_TYPE", userProfileJsonObj).equalsIgnoreCase("Demo")) {
            ...
            ((MTextView) view.findViewById(R.id.demonoteText)).setVisibility(View.GONE);
        } else {
...
//        String STRIPE_PUBLISH_KEY = generalFunc.getJsonValue("STRIPE_PUBLISH_KEY", userProfileJson);
    ...
    public void setLabels() {
        ...
        creditCardBox.setHint(generalFunc.retrieveLangLBl("", "LBL_CARD_NUMBER_HINT_TXT"));
