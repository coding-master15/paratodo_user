...
import com.paratodo.user.DonationActivity;
import com.paratodo.user.EmergencyContactActivity;
import com.paratodo.user.FavouriteDriverActivity;
import com.paratodo.user.HelpActivity;
import com.paratodo.user.InviteFriendsActivity;
import com.paratodo.user.MenuSettingActivity;
import com.paratodo.user.MyProfileActivity;
import com.paratodo.user.MyWalletActivity;
import com.paratodo.user.NotificationActivity;
import com.paratodo.user.R;
import com.paratodo.user.SearchPickupLocationActivity;
import com.paratodo.user.StaticPageActivity;
...
//        if (generalFunc.getJsonValueStr(Utils.DONATION_ENABLE, obj_userProfile).equalsIgnoreCase("Yes")/* && !APP_TYPE.equals(Utils.CabGeneralTypeRide_Delivery_UberX)*/) {
        ...
        if (isDeliverOnlyEnabled || isAnyDeliverOptionEnabled) {
    ...
    public void setuserInfo() {
        ...
        userEmailTxt.setText(Utils.checkText(vEmail) ? vEmail : vPhone);
...
//                showCartAlert();
    ...
    public void showPasswordBox() {
        ...
        final TextInputEditText previous_passwordBox = (TextInputEditText) dialogView.findViewById(R.id.editBox).findViewWithTag("edittext");
        previous_passwordBox.setHint(generalFunc.retrieveLangLBl("", "LBL_CURR_PASS_HEADER"));
        ...
        final TextInputEditText newPasswordBox = (TextInputEditText) dialogView.findViewById(R.id.newPasswordBox).findViewWithTag("edittext");
        ...
        final TextInputEditText reNewPasswordBox = (TextInputEditText) dialogView.findViewById(R.id.reNewPasswordBox).findViewWithTag("edittext");
...
//        });
    ...
    public void changePassword(String currentPassword, String password, TextInputEditText previous_passwordBox) {
